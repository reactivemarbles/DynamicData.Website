...
Title: Social media
---
We use social media to build relationships with DynamicData users and share all the cool stuff we do. But it also creates opportunities to say the wrong thing, put off developers, and damage our brand. So we’re careful and deliberate in what we post to our social channels. This section lays out how we strike that delicate balance.

## Basics

DynamicData has a presence on most major social media platforms. Here are our most active accounts and what we usually post on each:
...
Do your best to adhere to DynamicData style guidelines when you’re using our social media channels to correspond with users. Use correct grammar and punctuation—and avoid excessive exclamation points.
...
We employ hashtags rarely and deliberately. We may use them to promote an event or connect with users at a conference. Do not use current event or trending hashtags to promote DynamicData.

## Trending topics

Do not use social media to comment on trending topics or current events that are unrelated to DynamicData.

Be aware of what’s going on in the news when you're publishing social content for DynamicData. During major breaking news events, avoid social posts.
